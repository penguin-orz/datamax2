...
def convert_with_monitoring(file_path: str, thread_id: int):
    ...
    try:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            logger.info(f"{'✅' if success else '❌'} [线程{thread_id}] "
...
def test_parallel_performance():
    ...
    for max_workers in thread_counts:
        ...
        if successful:
            ...
            logger.info(f"📊 {max_workers}线程结果: 总时间={total_time:.2f}s, 效率={efficiency:.2f}x")
    ...
    for workers, data in results.items():
        ...
        logger.info(f"{workers}线程: 效率={efficiency:.2f}x, 理想={ideal_efficiency}x, "
